...
class JX1DX1Num {
    ...
    if (typeof n == "string") {
      ...
      if (!R.replace(/\d+/g,"")) {
        ...
        if (typeof R == "number") {
          ...
          if (R <= Number.MAX_SAFE_INTEGER) this.arr = [[0n, Number(R)]];
          else this.arr = [[0n, log10BN(R)], [1n, 1]];
        }
      }
  ...
  toString() {
    ...
    if (this.arr.length>-1) {
      if (this.arr.length>1) res += String(Math.floor(this.arr[0][1]))
